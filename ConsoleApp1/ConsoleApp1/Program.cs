...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        public ContactGenerator()
        {
            ...
            String outputFileName = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\customers.csv";
        ...
        {
            String firstNames = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\firstNames.txt";
            return ReturnRandomLine(firstNames);
        }

        public string GenerateLastName()
        {
            String lastNames = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\lastNames.txt";
            return ReturnRandomLine(lastNames);
        }
        public string GenerateStreetName()
        {
            String StreetNames = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\StreetNames.txt";
            return ReturnRandomLine(StreetNames);
        }
        public string GenerateCity()
        {
            String City = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\City.txt";
            return ReturnRandomLine(City);
        }
        public string GenerateStreetNumber()
        {
            String StreetNumber = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\StreetNumber.txt";
            return ReturnRandomLine(StreetNumber);
        }
        public string GeneratePostalCode()
        {
            String PostalCode = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\PostalCode.txt";
            return ReturnRandomLine(PostalCode);
        }
        public string GenerateCountry()
        {
            String Country = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\Country.txt";
            return ReturnRandomLine(Country);
        }
        public string GenerateProvince()
        {
            String Province = @"C:\Users\User\Documents\MCDA5510_Assignments\ConsoleApp1\ConsoleApp1\Province.txt";
